...
const TRANSLATIONS = {
  zh: {
    ...
    bathRefTitle:"配方參考值",
    targetSaltDoseLabel:"目標芒硝濃度", targetSaltTotalLabel:"目標芒硝重量", targetRatioLabel:"目標浴比", targetWaterLabel:"目標總浴量", targetSGLabel:"目標理論比重",
    bathTotalWaterLabel:"目前進水量", bathSaltTotalLabel:"已投芒硝量",
    tempLabel:"比重量測溫度",
    measuredSGLabel:"量測比重(手動輸入)", measuredSGPlaceholder:"請輸入實測比重",
    sgConcLabel:"反查濃度", actualWaterLabel:"缸內實際水量", makeupWaterLabel:"還需補水量", addSaltLabel:"建議加芒硝量", startLevelLabel:"目前液位比例", calibTag:"校正：",
  ...
  en: {
    ...
    targetSaltDoseLabel:"Target Glauber's salt conc.", targetSaltTotalLabel:"Target Glauber's salt weight", targetRatioLabel:"Target liquor ratio", targetWaterLabel:"Target total liquor", targetSGLabel:"Target theoretical SG",
    bathTotalWaterLabel:"Water added so far", bathSaltTotalLabel:"Glauber's salt dosed",
    tempLabel:"SG reading temperature",
    measuredSGLabel:"Measured SG (manual entry)", measuredSGPlaceholder:"Enter measured SG",
    sgConcLabel:"Concentration (looked up)", actualWaterLabel:"Actual tank water", makeupWaterLabel:"Make-up water needed", addSaltLabel:"Suggested extra Glauber's salt", startLevelLabel:"Current fill level", calibTag:"Calibration: ",
