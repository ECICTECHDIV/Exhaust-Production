...
const TRANSLATIONS = {
  zh: {
    ...
    bathRefTitle:"配方參考值",
    targetSaltDoseLabel:"芒硝濃度(目標)", targetSaltTotalLabel:"芒硝重量(目標)", targetRatioLabel:"浴比", targetWaterLabel:"總水量(目標)", targetSGLabel:"理論比重(目標)",
    bathTotalWaterLabel:"目前水量", bathSaltTotalLabel:"已投芒硝量",
    tempLabel:"比重量測溫度", expectedSGLabel:"理論比重(實際)",
  ...
  en: {
    ...
    targetSaltDoseLabel:"Glauber's salt conc. (target)", targetSaltTotalLabel:"Glauber's salt weight (target)", targetRatioLabel:"Liquor ratio", targetWaterLabel:"Total water (target)", targetSGLabel:"Theoretical SG (target)",
    bathTotalWaterLabel:"Current water volume", bathSaltTotalLabel:"Glauber's salt dosed",
    tempLabel:"SG reading temperature", expectedSGLabel:"Theoretical SG (actual)",
    measuredSGLabel:"Measured SG (manual entry)", measuredSGPlaceholder:"Enter measured SG",
    sgConcLabel:"Concentration (looked up)", actualWaterLabel:"Actual tank water", makeupWaterLabel:"Make-up water needed", addSaltLabel:"Suggested extra Glauber's salt", startLevelLabel:"Current fill level",
