...
const TRANSLATIONS = {
  zh: {
    ...
    alkaliRecTitle:"建議鹽鹼用量", saltDoseLabel:"電解質（芒硝／鹽）", fixTimeLabel:"建議固著時間",
    ...
    totalLiquorLabel:"總浴液量（布重 × 浴比）", saltTotalLabel:"電解質總需求量",
    ...
    bathTotalWaterLabel:"總水量（來自配方卡）", bathSaltTotalLabel:"已投電解質量（來自配方卡）",
    tempLabel:"比重量測溫度", measuredSGLabel:"量測比重",
    sgConcLabel:"反查濃度", actualWaterLabel:"缸內實際水量", makeupWaterLabel:"還需補水量", addSaltLabel:"建議加芒硝量", startLevelLabel:"目前液位比例",
    ...
    totalLiquorColLabel:"總浴液量", saltDoseColLabel:"電解質用量", saltTotalColLabel:"電解質總量",
  ...
  en: {
    ...
    alkaliRecTitle:"Suggested Salt/Alkali Dosing", saltDoseLabel:"Electrolyte (Glauber's salt / NaCl)", fixTimeLabel:"Suggested fixation time",
    ...
    totalLiquorLabel:"Total liquor (weight × ratio)", saltTotalLabel:"Total electrolyte needed",
    ...
    bathTotalWaterLabel:"Total water (from recipe)", bathSaltTotalLabel:"Electrolyte dosed (from recipe)",
    tempLabel:"SG reading temperature", measuredSGLabel:"Measured specific gravity",
    sgConcLabel:"Concentration (looked up)", actualWaterLabel:"Actual tank water", makeupWaterLabel:"Make-up water needed", addSaltLabel:"Suggested extra electrolyte", startLevelLabel:"Current fill level",
    ...
    totalLiquorColLabel:"Total liquor", saltDoseColLabel:"Electrolyte dose", saltTotalColLabel:"Electrolyte total",
